	...
	function (msg, model) {
		...
		if (_p4.ctor === 'AddToCart') {
			...
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					cart: A2(_elm_lang$core$Basics_ops['++'], model.cart, products)
				});
		} else {
			var cart = A2(
				_elm_lang$core$List$filter,
...
var _user$project$ShoppingCart$mockProduct = function (id) {
	return A4(
		_user$project$ShoppingCart$Product,
		id,
		A2(
			_elm_lang$core$Basics_ops['++'],
			'product ',
...
var _user$project$ShoppingCart$Model = F2(
	function (a, b) {
		return {products: a, cart: b};
	});
var _user$project$ShoppingCart$RemoveFromCart = function (a) {
	return {ctor: 'RemoveFromCart', _0: a};
};
...
var _user$project$ShoppingCart$main = _elm_lang$html$Html$beginnerProgram(
	{model: _user$project$ShoppingCart$model, view: _user$project$ShoppingCart$view, update: _user$project$ShoppingCart$update})();

var Elm = {};
Elm['ShoppingCart'] = Elm['ShoppingCart'] || {};
if (typeof _user$project$ShoppingCart$main !== 'undefined') {
    _user$project$ShoppingCart$main(Elm['ShoppingCart'], 'ShoppingCart', undefined);
}
